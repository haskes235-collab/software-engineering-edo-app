...
class SQLiteNumericNumberBuilder extends (_La = SQLiteColumnBuilder, _Ka = entityKind, _La) {
  constructor(name) {
...
__publicField(SQLiteNumericNumberBuilder, _Ka, "SQLiteNumericNumberBuilder");
class SQLiteNumericNumber extends (_Na = SQLiteColumn, _Ma = entityKind, _Na) {
  constructor() {
    super(...arguments);
...
__publicField(SQLiteNumericNumber, _Ma, "SQLiteNumericNumber");
class SQLiteNumericBigIntBuilder extends (_Pa = SQLiteColumnBuilder, _Oa = entityKind, _Pa) {
  constructor(name) {
...
__publicField(SQLiteNumericBigIntBuilder, _Oa, "SQLiteNumericBigIntBuilder");
class SQLiteNumericBigInt extends (_Ra = SQLiteColumn, _Qa = entityKind, _Ra) {
  constructor() {
    super(...arguments);
...
__publicField(SQLiteNumericBigInt, _Qa, "SQLiteNumericBigInt");
function numeric(a, b) {
  const { name, config } = getColumnNameAndConfig(a, b);
  const mode = config == null ? void 0 : config.mode;
  return mode === "number" ? new SQLiteNumericNumberBuilder(name) : mode === "bigint" ? new SQLiteNumericBigIntBuilder(name) : new SQLiteNumericBuilder(name);
}
class SQLiteRealBuilder extends (_Ta = SQLiteColumnBuilder, _Sa = entityKind, _Ta) {
  constructor(name) {
...
__publicField(SQLiteRealBuilder, _Sa, "SQLiteRealBuilder");
class SQLiteReal extends (_Va = SQLiteColumn, _Ua = entityKind, _Va) {
  getSQLType() {
    return "real";
  }
}
__publicField(SQLiteReal, _Ua, "SQLiteReal");
function real(name) {
  return new SQLiteRealBuilder(name ?? "");
}
class SQLiteTextBuilder extends (_Xa = SQLiteColumnBuilder, _Wa = entityKind, _Xa) {
...
__publicField(SQLiteTextBuilder, _Wa, "SQLiteTextBuilder");
class SQLiteText extends (_Za = SQLiteColumn, _Ya = entityKind, _Za) {
  constructor(table, config) {
    super(table, config);
...
__publicField(SQLiteText, _Ya, "SQLiteText");
class SQLiteTextJsonBuilder extends (_$a = SQLiteColumnBuilder, __a = entityKind, _$a) {
  constructor(name) {
...
__publicField(SQLiteTextJsonBuilder, __a, "SQLiteTextJsonBuilder");
class SQLiteTextJson extends (_bb = SQLiteColumn, _ab = entityKind, _bb) {
  getSQLType() {
    return "text";
  }
  mapFromDriverValue(value) {
...
__publicField(SQLiteTextJson, _ab, "SQLiteTextJson");
function text(a, b = {}) {
  const { name, config } = getColumnNameAndConfig(a, b);
  if (config.mode === "json") {
...
__publicField(_SelectionProxyHandler, _cb, "SelectionProxyHandler");
...
__publicField(IndexBuilderOn, _ib, "SQLiteIndexBuilderOn");
_jb = entityKind;
class IndexBuilder {
...
__publicField(IndexBuilder, _jb, "SQLiteIndexBuilder");
_kb = entityKind;
class Index {
...
__publicField(Index, _kb, "SQLiteIndex");
function index(name) {
...
class SQLiteDeleteBase extends (_mb = QueryPromise, _lb = entityKind, _mb) {
...
__publicField(SQLiteDeleteBase, _lb, "SQLiteDelete");
...
__publicField(CasingCache, _nb, "CasingCache");
